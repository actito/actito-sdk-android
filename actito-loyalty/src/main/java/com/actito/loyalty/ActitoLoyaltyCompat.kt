...
import com.actito.loyalty.ktx.INTENT_ACTION_PASSBOOK_OPENED
...
public object ActitoLoyaltyCompat {

    // region Intent actions

    @JvmField
    public val INTENT_ACTION_PASSBOOK_OPENED: String = Actito.INTENT_ACTION_PASSBOOK_OPENED
    ...
    @JvmField
    public val INTENT_EXTRA_PASSBOOK: String = Actito.INTENT_EXTRA_PASSBOOK
    ...
    public var passbookActivity: Class<out PassbookActivity>
        get() = Actito.loyalty().passbookActivity
        set(value) {
            Actito.loyalty().passbookActivity = value
        }
    ...
    public fun fetchPassBySerial(serial: String, callback: ActitoCallback<ActitoPass>) {
        Actito.loyalty().fetchPassBySerial(serial, callback)
    }
    ...
    public fun fetchPassByBarcode(barcode: String, callback: ActitoCallback<ActitoPass>) {
        Actito.loyalty().fetchPassByBarcode(barcode, callback)
    }
