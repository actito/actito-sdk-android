...
import com.actito.iam.databinding.ActitoInAppMessageCardFragmentBinding
...
public open class InAppMessagingCardFragment : InAppMessagingBaseFragment() {
    private lateinit var binding: ActitoInAppMessageCardFragmentBinding

    override val animatedView: View
        get() = binding.cardView

    override val enterAnimation: Int = R.anim.actito_iam_card_enter_animation
    override val exitAnimation: Int = R.anim.actito_iam_card_exit_animation

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = ActitoInAppMessageCardFragmentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.secondaryActionButton.setOnClickListener {
            handleActionClicked(ActitoInAppMessage.ActionType.SECONDARY)
        }
    ...
    private fun canShowAction(action: ActitoInAppMessage.Action?): Boolean {
