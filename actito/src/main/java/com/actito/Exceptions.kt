...
public class ActitoNotConfiguredException : Exception(
    "Actito hasn't been configured. Call Actito.configure() or enable the configuration provider."
)

public class ActitoNotReadyException : Exception(
    "Actito is not ready. Call Actito.launch() and wait for the 'ready' event."
)

public class ActitoDeviceUnavailableException : Exception(
    "Actito device unavailable at the moment. It becomes available after the first ready event."
)

public class ActitoApplicationUnavailableException : Exception(
