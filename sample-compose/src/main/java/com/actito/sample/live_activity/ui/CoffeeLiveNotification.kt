package com.actito.sample.live_activity.ui
...
import com.actito.sample.SamplePushIntentReceiver
import com.actito.sample.ktx.setBackgroundResource
import com.actito.sample.ktx.setColorFilter
...
class CoffeeLiveNotification(
    ...
    fun build(): Notification {
        ...
        return NotificationCompat.Builder(context, LiveActivityController.CHANNEL_LIVE_ACTIVITY)
    ...
    private fun createExpandedLayout(): RemoteViews {
        val view = RemoteViews(
            context.packageName,
            R.layout.notification_coffee_brewer_expanded,
        )
    ...
    private fun getBackgroundCircleResource(
        representedState: CoffeeBrewingState,
    ): Int = if (shouldHighlightView(contentState.state, representedState)) {
