...
import com.actito.sample.live_activity.ui.CoffeeLiveNotification
...
object LiveActivityController {
    const val CHANNEL_LIVE_ACTIVITY = "live-activity"

    private val notificationCounter = AtomicInteger(0)
    private lateinit var context: Context
    private lateinit var dataStore: ActitoDataStore
    ...
    fun setup(context: Context) {
        ...
        this.dataStore = ActitoDataStore(applicationContext)
