...
public class ActitoStoreFragment : NotificationFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var content: ActitoNotification.Content? = notification.content.firstOrNull {
            it.type == ActitoNotification.Content.TYPE_GOOGLE_PLAY_DETAILS
        }
        ...
        if (content != null) {
            ...
            content = notification.content.firstOrNull {
                it.type == ActitoNotification.Content.TYPE_GOOGLE_PLAY_DEVELOPER
            }
            ...
            if (content != null) {
                ...
                content = notification.content.firstOrNull {
                    it.type == ActitoNotification.Content.TYPE_GOOGLE_PLAY_SEARCH
                }
                ...
                if (content != null) {
                    ...
                    content = notification.content.firstOrNull {
                        it.type == ActitoNotification.Content.TYPE_GOOGLE_PLAY_COLLECTION
                    }
