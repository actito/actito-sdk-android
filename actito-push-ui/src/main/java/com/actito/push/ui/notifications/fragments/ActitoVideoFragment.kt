...
public class ActitoVideoFragment : NotificationFragment() {
    ...
    private lateinit var binding: ActitoNotificationVideoFragmentBinding
    private var customView: View? = null
    private var customViewCallback: WebChromeClient.CustomViewCallback? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = ActitoNotificationVideoFragmentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    public inner class VideoChromeClient : WebChromeClient() {
        override fun onShowCustomView(view: View, callback: CustomViewCallback) {
            ...
            this@ActitoVideoFragment.callback.onNotificationFragmentCanHideActionBar()
        }
        ...
        override fun onHideCustomView() {
            ...
            this@ActitoVideoFragment.customView = null
