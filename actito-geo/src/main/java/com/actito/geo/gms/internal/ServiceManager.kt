package com.actito.geo.gms.internal
...
public class ServiceManager : ServiceManager() {
    ...
    @SuppressLint("MissingPermission")
    override suspend fun startMonitoringRegions(regions: List<ActitoRegion>) {
    ...
    override suspend fun stopMonitoringRegions(regions: List<ActitoRegion>) {
        try {
