...
import com.actito.geo.internal.isValid
...
public object ActitoGeo {
    ...
    internal var beaconServiceManager: BeaconServiceManager? = null
    ...
    @InternalActitoApi
    public const val INTENT_ACTION_INTERNAL_LOCATION_UPDATED: String = "com.actito.intent.action.internal.LocationUpdated"

    @InternalActitoApi
    public const val INTENT_ACTION_INTERNAL_GEOFENCE_TRANSITION: String = "com.actito.intent.action.internal.GeofenceTransition"
    ...
    public const val INTENT_ACTION_REGION_EXITED: String = "com.actito.intent.action.RegionExited"
    ...
    public const val INTENT_EXTRA_LOCATION: String = "com.actito.intent.extra.Location"
    public const val INTENT_EXTRA_REGION: String = "com.actito.intent.extra.Region"
    public const val INTENT_EXTRA_BEACON: String = "com.actito.intent.extra.Beacon"
    public const val INTENT_EXTRA_RANGED_BEACONS: String = "com.actito.intent.extra.RangedBeacons"
    ...
    internal fun handleLocationUpdate(location: Location) {
        if (!location.isValid) {
            logger.warning(
    ...
    internal fun handleRegionEnter(identifiers: List<String>) {
    ...
    internal fun handleRegionExit(identifiers: List<String>) {
        identifiers.forEach { regionId ->
            val region = localStorage.monitoredRegions[regionId] ?: run {
    ...
    internal fun setupLocationService(context: Context) {
        ...
        val locationIntent = Intent(context, LocationReceiver::class.java)
            .setAction(INTENT_ACTION_INTERNAL_LOCATION_UPDATED)
        ...
        val geofencingIntent = Intent(context, LocationReceiver::class.java)
            .setAction(INTENT_ACTION_INTERNAL_GEOFENCE_TRANSITION)
    ...
    @SuppressLint("MissingPermission")
    internal fun enableLocationUpdatesInternal() {
        // Ensure we keep the bluetooth state updated in the API.
        updateBluetoothState(beaconSupport.isEnabled)
    ...
    internal fun disableLocationUpdatesInternal() {
    ...
    internal suspend fun clearLocation(): Unit = withContext(Dispatchers.IO) {
        val device = Actito.device().currentDevice ?: run {
    ...
    public interface Listener {
         ...
         *
         * @param location The updated [ActitoLocation] representing the user's new location.
         *
         * @see [ActitoLocation]
         */
        @MainThread
        public fun onLocationUpdated(location: ActitoLocation) {
        }

        /**
         * Called when the user enters a monitored region.
         *
         * @param region The [ActitoRegion] representing the region the user has entered.
         *
         * @see [ActitoRegion]
         */
        @MainThread
        public fun onRegionEntered(region: ActitoRegion) {
        }

        /**
         * Called when the user exits a monitored region.
         *
         * @param region The [ActitoRegion] representing the region the user has exited.
         *
         * @see [ActitoRegion]
         */
        @MainThread
        public fun onRegionExited(region: ActitoRegion) {
        }

        /**
         * Called when the user enters the proximity of a beacon.
         *
         * @param beacon The [ActitoBeacon] representing the beacon the user has entered the proximity of.
         *
         * @see [ActitoBeacon]
         */
        @MainThread
        public fun onBeaconEntered(beacon: ActitoBeacon) {
        }

        /**
         * Called when the user exits the proximity of a beacon.
         *
         * @param beacon The [ActitoBeacon] representing the beacon the user has exited the proximity of.
         *
         * @see [ActitoBeacon]
         */
        @MainThread
        public fun onBeaconExited(beacon: ActitoBeacon) {
        }
         ...
         *
         * @param region The [ActitoRegion] where beacons were ranged.
         * @param beacons A list of [ActitoBeacon] that were detected in the region.
         *
         * @see [ActitoRegion]
         * @see [ActitoBeacon]
         */
        @MainThread
        public fun onBeaconsRanged(region: ActitoRegion, beacons: List<ActitoBeacon>) {
        }
    }
}
