...
internal fun ActitoRegion.contains(location: Location): Boolean {
    if (this.isPolygon) {
...
private fun ActitoRegion.AdvancedGeometry.contains(location: Location): Boolean {
...
internal fun ActitoBeaconSession.canInsertBeacon(beacon: ActitoBeacon): Boolean {
