...
import com.actito.sample.user.inbox.R
import com.actito.sample.user.inbox.databinding.RowInboxItemBinding
import com.actito.sample.user.inbox.ktx.dp
...
class InboxAdapter(
    private val onInboxItemClicked: (ActitoUserInboxItem) -> Unit,
    private val onInboxItemLongPressed: (ActitoUserInboxItem) -> Unit,
...
private class InboxDiffCallback : DiffUtil.ItemCallback<ActitoUserInboxItem>() {
    override fun areItemsTheSame(oldItem: ActitoUserInboxItem, newItem: ActitoUserInboxItem): Boolean {
        return oldItem.id == newItem.id
    }

    override fun areContentsTheSame(oldItem: ActitoUserInboxItem, newItem: ActitoUserInboxItem): Boolean {
