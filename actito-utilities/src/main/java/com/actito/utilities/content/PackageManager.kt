package com.actito.utilities.content
...
public fun PackageManager.activityInfo(component: ComponentName, flags: Int): ActivityInfo {
    return when {
        ...
        else -> @Suppress("ktlint:standard:annotation") getActivityInfo(component, flags)
    }
}
...
public fun PackageManager.applicationInfo(packageName: String, flags: Int): ApplicationInfo {
    return when {
        ...
        else -> @Suppress("ktlint:standard:annotation") getApplicationInfo(packageName, flags)
    }
}
...
public fun PackageManager.packageInfo(packageName: String, flags: Int): PackageInfo {
    return when {
        ...
        else -> @Suppress("ktlint:standard:annotation") getPackageInfo(packageName, flags)
    }
}
