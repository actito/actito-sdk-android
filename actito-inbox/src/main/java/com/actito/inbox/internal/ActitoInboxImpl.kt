...
internal object ActitoInboxImpl : ActitoModule(), ActitoInbox {
    ...
    override val items: SortedSet<ActitoInboxItem>
        get() {
    ...
    override val observableItems: LiveData<SortedSet<ActitoInboxItem>> = _itemsStream.asLiveData()
    override val itemsStream: StateFlow<SortedSet<ActitoInboxItem>> = _itemsStream
    ...
    override suspend fun open(item: ActitoInboxItem): ActitoNotification = withContext(Dispatchers.IO) {
        checkPrerequisites()
    ...
    override fun open(item: ActitoInboxItem, callback: ActitoCallback<ActitoNotification>): Unit =
        toCallbackFunction(ActitoInboxImpl::open)(item, callback::onSuccess, callback::onFailure)

    override suspend fun markAsRead(item: ActitoInboxItem): Unit = withContext(Dispatchers.IO) {
        checkPrerequisites()
    ...
    override fun markAsRead(item: ActitoInboxItem, callback: ActitoCallback<Unit>): Unit =
        toCallbackFunction(ActitoInboxImpl::markAsRead)(item, callback::onSuccess, callback::onFailure)
    ...
    override fun markAllAsRead(callback: ActitoCallback<Unit>): Unit =
        toCallbackFunction(ActitoInboxImpl::markAllAsRead)(callback::onSuccess, callback::onFailure)

    override suspend fun remove(item: ActitoInboxItem): Unit = withContext(Dispatchers.IO) {
        checkPrerequisites()
    ...
    override fun remove(item: ActitoInboxItem, callback: ActitoCallback<Unit>): Unit =
        toCallbackFunction(ActitoInboxImpl::remove)(item, callback::onSuccess, callback::onFailure)
    ...
    override fun clear(callback: ActitoCallback<Unit>): Unit =
        toCallbackFunction(ActitoInboxImpl::clear)(callback::onSuccess, callback::onFailure)
